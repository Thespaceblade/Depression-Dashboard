...
- `docs/API.md` - Current API status and options
- `docs/archive/IMPLEMENTATION_SUMMARY.md` - What's been implemented
- `docs/archive/VISUAL_IMPLEMENTATION_PLAN.md` - Original implementation plan
- `docs/archive/PLAN.md` - Original project plan
